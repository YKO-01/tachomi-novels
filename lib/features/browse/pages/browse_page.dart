          ...
          Container(
            ...
            child: ListView(
              ...
              children: [
                ...
                custom.FilterChip(
                  label: AppConstants.filterDramatic,
                  isSelected: _selectedFilter == AppConstants.filterDramatic,
                  onTap: () => _onFilterChanged(AppConstants.filterDramatic),
                ),
                const SizedBox(width: AppConstants.spacingS),
                custom.FilterChip(
                  label: AppConstants.filterRevenge,
                  isSelected: _selectedFilter == AppConstants.filterRevenge,
                  onTap: () => _onFilterChanged(AppConstants.filterRevenge),
                ),
                const SizedBox(width: AppConstants.spacingS),
                custom.FilterChip(
                  label: AppConstants.filterLove,
                  isSelected: _selectedFilter == AppConstants.filterLove,
                  onTap: () => _onFilterChanged(AppConstants.filterLove),
                ),
                const SizedBox(width: AppConstants.spacingS),
                custom.FilterChip(
                  label: AppConstants.filterRomantic,
                  isSelected: _selectedFilter == AppConstants.filterRomantic,
                  onTap: () => _onFilterChanged(AppConstants.filterRomantic),
                ),
              ],
            ),
          ),
